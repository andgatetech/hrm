...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2015 at 10:45 AM
...
('beacon.uuid', 'eRQOCN1rEgnQkw=='),
('csrf_secret', 'edf7ktnoclkt1ige3eoo3o522rjl9nd165h0m9s0835o1lb1v1g'),
...
CREATE TABLE IF NOT EXISTS `hs_hr_employee` (
  ...
  `thana_code` varchar(255) NOT NULL,
...
INSERT INTO `hs_hr_employee` (`emp_number`, `employee_id`, `emp_lastname`, `emp_firstname`, `emp_middle_name`, `emp_nick_name`, `emp_smoker`, `ethnic_race_code`, `emp_birthday`, `nation_code`, `emp_gender`, `emp_marital_status`, `emp_ssn_num`, `emp_sin_num`, `emp_other_id`, `emp_dri_lice_num`, `emp_dri_lice_exp_date`, `emp_military_service`, `emp_status`, `job_title_code`, `eeo_cat_code`, `work_station`, `emp_street1`, `emp_street2`, `city_code`, `coun_code`, `thana_code`, `provin_code`, `emp_zipcode`, `emp_hm_telephone`, `emp_mobile`, `emp_work_telephone`, `emp_work_email`, `sal_grd_code`, `joined_date`, `emp_oth_email`, `termination_id`, `custom1`, `custom2`, `custom3`, `custom4`, `custom5`, `custom6`, `custom7`, `custom8`, `custom9`, `custom10`) VALUES
(1, '0001', 'Alam', 'Khorshed', '', '', 0, NULL, NULL, 9, NULL, '', '', '', '', '', NULL, '', NULL, NULL, NULL, NULL, '', '', '', 'BD', 'BRG', '', '', '', '', '', '', NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 1, 'Admin', 'Admin', 1, '2015-11-09 11:42:16'),
(2, 1, 'Admin', 'Admin', 1, '2015-11-09 11:43:57'),
(3, 1, 'Admin', 'Admin', 1, '2015-11-10 03:22:35'),
(4, 1, 'Admin', 'Admin', 1, '2015-11-10 05:57:25');
...
(1, 1, NULL, 'admin', '$2a$12$FDIN3.Frr.Lxrzyw6Lj/y.BMlwZT9E4kfi83pqSkati8H12t66u9S', 0, 1, NULL, NULL, NULL, NULL);
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `leave_taken_status_change` ON SCHEDULE EVERY 1 HOUR STARTS '2015-11-09 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
