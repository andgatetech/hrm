...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2015 at 01:30 PM
...
INSERT INTO `hs_hr_district` (`district_code`, `district_name`, `division_code`, `province_code`) VALUES
('BOG', 'Bogra', 'RS', NULL),
('JOY', 'Joypurhat', 'RS', NULL),
('NAO', 'Naogaon', 'RS', NULL),
('NAT', 'Natore', 'RS', NULL),
('NAW', 'Nawabganj', 'RS', NULL),
('PAB', 'Pabna', 'RS', NULL),
('RAJ', 'Rajshahi', 'RS', NULL),
('SIR', 'Sirajganj', 'RS', NULL);
...
CREATE TABLE IF NOT EXISTS `hs_hr_division` (
  ...
  `cou_code` char(2) NOT NULL DEFAULT 'BD'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `hs_hr_division` (`id`, `division_name`, `division_code`, `cou_code`) VALUES
(1, 'Dhaka', 'DA', 'BD'),
(2, 'Chittagong', 'CG', 'BD'),
(3, 'Sylhet', 'SY', 'BD'),
(4, 'Rangpur', 'RP', 'BD'),
...
(1, '0001', 'Alam', 'Khorshed', '', '', 0, NULL, NULL, 9, NULL, 'Married', '', '', '', '', NULL, '', 5, 1, 10, NULL, '', '', '', 'KH', 'NAW', 'JOY-KAL', 'BD', '', '', '', '', '', '', NULL, '2013-12-03', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `hs_hr_thana` (
  `thana_code` varchar(13) NOT NULL DEFAULT '',
  `thana_name` varchar(50) DEFAULT NULL,
...
('JOY-AKK', 'Akkelpur', 'JOY'),
('JOY-JOY', 'Joypurhat', 'JOY'),
('JOY-KAL', 'Kalai', 'JOY');
