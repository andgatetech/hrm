...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2015 at 12:27 PM
...
('beacon.uuid', '90MPW2yFGxltmg=='),
('csrf_secret', '1odu2kclg7678vjt7jdq67ovbs7njov3n5197mq4a28jlcop319ohrag'),
...
--
-- Table structure for table `hs_hr_division`
--

CREATE TABLE IF NOT EXISTS `hs_hr_division` (
  `division_name` varchar(40) NOT NULL DEFAULT '',
  `division_code` char(2) NOT NULL DEFAULT '',
  `cou_code` char(2) DEFAULT 'BD'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `hs_hr_division`
--

INSERT INTO `hs_hr_division` (`division_name`, `division_code`, `cou_code`) VALUES
('Barishal', 'BR', 'BD'),
('Chittagong', 'CT', 'BD'),
('Dhaka', 'DA', 'BD'),
('Khulna', 'KH', 'BD'),
...
INSERT INTO `hs_hr_employee` (`emp_number`, `employee_id`, `emp_lastname`, `emp_firstname`, `emp_middle_name`, `emp_nick_name`, `emp_smoker`, `ethnic_race_code`, `emp_birthday`, `nation_code`, `emp_gender`, `emp_marital_status`, `emp_ssn_num`, `emp_sin_num`, `emp_other_id`, `emp_dri_lice_num`, `emp_dri_lice_exp_date`, `emp_military_service`, `emp_status`, `job_title_code`, `eeo_cat_code`, `work_station`, `emp_street1`, `emp_street2`, `city_code`, `division_code`, `district_code`, `thana_code`, `coun_code`, `provin_code`, `emp_zipcode`, `emp_hm_telephone`, `emp_mobile`, `emp_work_telephone`, `emp_work_email`, `sal_grd_code`, `joined_date`, `emp_oth_email`, `termination_id`, `custom1`, `custom2`, `custom3`, `custom4`, `custom5`, `custom6`, `custom7`, `custom8`, `custom9`, `custom10`) VALUES
(1, '201324', 'Alam', 'Khorshed', '', '', 0, NULL, NULL, 9, NULL, 'Married', '', '', '', '', NULL, '', 3, 1, 10, NULL, '', '', '', 'KH', 'NAW', 'JOY-KAL', 'BD', '', '', '', '', '', '', NULL, '2013-12-03', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 1, 1, 'BDT', '5000', '4', 'Base', ''),
(2, 1, 1, 'BDT', '4000', '4', 'House Rent', '');
...
INSERT INTO `hs_hr_emp_dependents` (`emp_number`, `ed_seqno`, `ed_name`, `ed_relationship_type`, `ed_relationship`, `ed_date_of_birth`) VALUES
(1, '1', 'Xyz', 'child', '', '2012-11-22');
...
--
-- Table structure for table `hs_hr_thana`
--

CREATE TABLE IF NOT EXISTS `hs_hr_thana` (
  `thana_code` varchar(13) NOT NULL,
  `thana_name` varchar(255) DEFAULT NULL,
  `district_code` varchar(13) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `hs_hr_thana`
--

INSERT INTO `hs_hr_thana` (`thana_code`, `thana_name`, `district_code`) VALUES
('', 'Joypur Hat', 'JOY');
...
(1, 1, '2015-11-19 05:33:00', '', '6', '2015-11-19 11:33:00', NULL, NULL, NULL, NULL, 'PUNCHED IN');
...
--
-- Table structure for table `ohrm_degree`
--

CREATE TABLE IF NOT EXISTS `ohrm_degree` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `ohrm_degree`
--

INSERT INTO `ohrm_degree` (`id`, `code`, `name`) VALUES
(1, 'BSc', 'Bachelor of Science'),
(4, 'MSc', 'Master of Science'),
(6, 'DPL', 'Diploma in CSE');
...
(1, 'Chismas Day', '2015-12-25', 1, 0, NULL);
...
(1, 'Team Manager', 'Manage several team. Monitor progress and report on demand.', '', 0),
(2, 'Team Lead', '', '', 0),
(3, 'Senior Engineer', '', '', 0),
(4, 'Engineer', '', '', 0),
(5, 'Junior Engineer', '', '', 0);
...
(1, 'R&D Center', 'BD', '', 'Dhaka', 'Gulshan 1', '1212', '01819646514', '', '');
...
(1, 1, 'Admin', 'Admin', 1, '2015-11-10 10:41:49'),
(2, 1, 'Admin', 'Admin', 1, '2015-11-10 12:31:37'),
(3, 1, 'Admin', 'Admin', 1, '2015-11-11 03:33:31'),
(4, 1, 'Admin', 'Admin', 1, '2015-11-11 03:45:05'),
(5, 1, 'Admin', 'Admin', 1, '2015-11-11 04:56:03'),
(6, 1, 'Admin', 'Admin', 1, '2015-11-11 05:46:24'),
(7, 1, 'Admin', 'Admin', 1, '2015-11-12 03:22:11'),
(8, 1, 'Admin', 'Admin', 1, '2015-11-12 05:20:46'),
(9, 1, 'Admin', 'Admin', 1, '2015-11-12 07:10:20'),
(10, 1, 'Admin', 'Admin', 1, '2015-11-12 09:37:14'),
(11, 1, 'Admin', 'Admin', 1, '2015-11-12 10:12:10'),
(12, 1, 'Admin', 'Admin', 1, '2015-11-12 11:00:12'),
(13, 1, 'Admin', 'Admin', 1, '2015-11-12 11:12:44'),
(14, 1, 'Admin', 'Admin', 1, '2015-11-12 11:24:19'),
(15, 1, 'Admin', 'Admin', 1, '2015-11-12 13:09:37'),
(16, 1, 'Admin', 'Admin', 1, '2015-11-16 03:26:09'),
(17, 1, 'Admin', 'Admin', 1, '2015-11-16 05:19:58'),
(18, 1, 'Admin', 'Admin', 1, '2015-11-17 04:01:47'),
(19, 1, 'Admin', 'Admin', 1, '2015-11-17 05:54:07'),
(20, 1, 'Admin', 'Admin', 1, '2015-11-17 08:19:07'),
(21, 1, 'Admin', 'Admin', 1, '2015-11-17 11:29:36'),
(22, 1, 'Admin', 'Admin', 1, '2015-11-18 03:54:39'),
(23, 1, 'Admin', 'Admin', 1, '2015-11-18 04:33:01'),
(24, 1, 'Admin', 'Admin', 1, '2015-11-18 04:36:05'),
(25, 1, 'Admin', 'Admin', 1, '2015-11-18 05:35:47'),
(26, 1, 'Admin', 'Admin', 1, '2015-11-18 09:03:51'),
(27, 1, 'Admin', 'Admin', 1, '2015-11-18 11:20:45'),
(28, 1, 'Admin', 'Admin', 1, '2015-11-18 12:18:27'),
(29, 1, 'Admin', 'Admin', 1, '2015-11-19 03:57:48'),
(30, 1, 'Admin', 'Admin', 1, '2015-11-19 05:08:36'),
(31, 1, 'Admin', 'Admin', 1, '2015-11-19 05:28:29'),
(32, 2, 'Khorshed', 'ESS', 1, '2015-11-19 05:31:30'),
(33, 1, 'Admin', 'Admin', 1, '2015-11-19 05:35:04'),
(34, 1, 'Admin', 'Admin', 1, '2015-11-19 06:12:23'),
(35, 1, 'Admin', 'Admin', 1, '2015-11-19 06:14:05'),
(36, 1, 'Admin', 'Admin', 1, '2015-11-19 06:15:01'),
(37, 1, 'Admin', 'Admin', 1, '2015-11-19 06:19:03'),
(38, 1, 'Admin', 'Admin', 1, '2015-11-19 09:06:32'),
(39, 1, 'Admin', 'Admin', 1, '2015-11-19 10:30:30'),
(40, 1, 'Admin', 'Admin', 1, '2015-11-20 04:23:27'),
(41, 1, 'Admin', 'Admin', 1, '2015-11-20 05:32:03'),
(42, 1, 'Admin', 'Admin', 1, '2015-11-20 06:14:38'),
(43, 1, 'Admin', 'Admin', 1, '2015-11-20 08:49:49'),
(44, 1, 'Admin', 'Admin', 1, '2015-11-20 08:54:15'),
(45, 1, 'Admin', 'Admin', 1, '2015-11-20 09:57:02'),
(46, 1, 'Admin', 'Admin', 1, '2015-11-23 03:47:58'),
(47, 1, 'Admin', 'Admin', 1, '2015-11-23 05:15:10'),
(48, 1, 'Admin', 'Admin', 1, '2015-11-23 05:40:11'),
(49, 1, 'Admin', 'Admin', 1, '2015-11-23 05:43:13'),
(50, 1, 'Admin', 'Admin', 1, '2015-11-23 06:16:57'),
(51, 1, 'Admin', 'Admin', 1, '2015-11-23 06:33:19'),
(52, 1, 'Admin', 'Admin', 1, '2015-11-23 06:44:08'),
(53, 1, 'Admin', 'Admin', 1, '2015-11-23 08:32:54'),
(54, 1, 'Admin', 'Admin', 1, '2015-11-23 11:49:46'),
(55, 1, 'Admin', 'Admin', 1, '2015-11-24 03:31:18'),
(56, 1, 'Admin', 'Admin', 1, '2015-11-24 03:31:25'),
(57, 1, 'Admin', 'Admin', 1, '2015-11-24 04:43:37'),
(58, 1, 'Admin', 'Admin', 1, '2015-11-24 09:19:54'),
(59, 1, 'Admin', 'Admin', 1, '2015-11-26 06:51:39'),
(60, 1, 'Admin', 'Admin', 1, '2015-11-26 08:59:55'),
(61, 1, 'Admin', 'Admin', 1, '2015-11-26 10:19:53');
...
(95, 'Sys Configuration', NULL, 1, 2, 1000, NULL, 1),
(96, 'Religion', 118, 95, 3, 100, NULL, 1),
(97, 'Degree', 119, 95, 3, 200, NULL, 1),
(98, 'Subject', 120, 95, 3, 300, NULL, 1),
(99, 'Division', 121, 95, 3, 400, NULL, 1),
(101, 'District', 122, 95, 3, 500, NULL, 1),
(102, 'Thana', 123, 95, 3, 600, NULL, 1);
...
--
-- Table structure for table `ohrm_religion`
--

CREATE TABLE IF NOT EXISTS `ohrm_religion` (
  `id` int(6) NOT NULL,
  `code` varchar(10) NOT NULL,
  `name` varchar(100) NOT NULL
...
--
-- Dumping data for table `ohrm_religion`
--

INSERT INTO `ohrm_religion` (`id`, `code`, `name`) VALUES
(3, 'ISM', 'Islam'),
(6, 'HNDD', 'Hinduismm'),
(8, 'BDH', 'Buddhism'),
(9, 'TST', 'test');
...
(118, 'View Religion', 2, 'religion'),
(119, 'View Degree', 2, 'degree'),
(120, 'View Subject', 2, 'subject'),
(121, 'View Division', 2, 'division'),
(122, 'View District', 2, 'district'),
(123, 'View Thana', 2, 'thana');
...
(2, 'PHP', 'PHP programming');

-- --------------------------------------------------------

--
-- Table structure for table `ohrm_subject`
--

CREATE TABLE IF NOT EXISTS `ohrm_subject` (
  `id` int(11) NOT NULL,
  `code` varchar(10) NOT NULL,
  `name` varchar(255) NOT NULL
...
--
-- Dumping data for table `ohrm_subject`
--

INSERT INTO `ohrm_subject` (`id`, `code`, `name`) VALUES
(1, 'CFu', 'Computer Fundamental'),
...
(1, 'Kona Software Lab Ltd', '', '', 1, 8, 0),
(2, 'Payment Lab', 'LAB-PAYMENT', 'Payment is a dedicated lab to build expertise and solution on payment domain', 2, 5, 1),
(3, 'Security Lab', 'LAB-SECURITY', 'Dedicated lab to development security solutions.', 6, 7, 1),
(4, 'EMV Solution Lab', 'LAB-EMV', 'Dedicated lab of EMV based solutions', 3, 4, 2);
...
(1, 'NOT SUBMITTED', '2015-11-15', '2015-11-21', 1);
...
(1, 1, NULL, 'admin', '$2a$12$LiMyIkpO.ZKCGPMpaNNg0ufzI.YwzF1UV1wpHf6KRIfJbHNO2Z5eu', 0, 1, NULL, NULL, NULL, NULL),
(2, 2, 1, 'khorshed', '$2a$12$tjdhLHrwTMhon6SVD99lAO5EITahIVwHUsSphLWcJF1fDCugxM7uC', 0, 1, '2015-11-19 06:31:13', NULL, NULL, 1);
...
(1, 'Regular Day Shift', '8.50', '09:00:00', '17:30:00');
...
ALTER TABLE `hs_hr_district`
  ADD PRIMARY KEY (`district_code`), ADD KEY `hs_hr_district_ibfk_1` (`division_code`);

--
-- Indexes for table `hs_hr_division`
--
ALTER TABLE `hs_hr_division`
...
--
-- Indexes for table `hs_hr_thana`
--
ALTER TABLE `hs_hr_thana`
...
--
-- Indexes for table `ohrm_degree`
--
ALTER TABLE `ohrm_degree`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ohrm_religion`
--
ALTER TABLE `ohrm_religion`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ohrm_subject`
--
ALTER TABLE `ohrm_subject`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ohrm_degree`
--
ALTER TABLE `ohrm_degree`
...
--
ALTER TABLE `ohrm_employee_work_shift`
  MODIFY `work_shift_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `ohrm_religion`
--
ALTER TABLE `ohrm_religion`
...
ALTER TABLE `ohrm_skill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ohrm_subject`
--
ALTER TABLE `ohrm_subject`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
-- Constraints for table `hs_hr_district`
--
ALTER TABLE `hs_hr_district`
ADD CONSTRAINT `hs_hr_district_ibfk_1` FOREIGN KEY (`division_code`) REFERENCES `hs_hr_division` (`division_code`) ON DELETE CASCADE;
...
ADD CONSTRAINT `ohrm_emp_education_ibfk_2` FOREIGN KEY (`education_id`) REFERENCES `ohrm_degree` (`id`) ON DELETE CASCADE;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `leave_taken_status_change` ON SCHEDULE EVERY 1 HOUR STARTS '2015-11-10 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
