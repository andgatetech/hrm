 ...
 */
class DegreeDao extends BaseDao {
    ...
    public function getDegreeById($id) {
        ...
        try {
            return Doctrine::getTable('Degree')->find($id);
        } catch (Exception $e) {
            throw new DaoException($e->getMessage(), $e->getCode(), $e);
        }
    ...
    public function getDegreeByCode($code) {
    ...
    public function getDegreeList() {
        ...
        try {
            ...
            $q = Doctrine_Query::create()->from('Degree')
                                         ->orderBy('name');
    ...
    public function deleteDegrees($toDeleteIds) {
        ...
        try {
            ...
            $q = Doctrine_Query::create()->delete('Degree')
    ...
    public function isExistingDegreeName($degreeName) {
        ...
        try {
            ...
            $q = Doctrine_Query:: create()->from('Degree d')
                            ->where('d.name = ?', trim($DegreeName));
