...
class DivisionService extends BaseService{
  private $divisionDao;
    ...
    public function setDivisionDao(DivisionDao $divisionDao) {
    ...
    public function getDivisionById($divisionId) {
    	return $this->divisionDao->getDivisionById($divisionId);
    }
    ...
    public function deleteDivisions($divisionList) {
        return $this->divisionDao->deleteDivisions($divisionList);
    }
