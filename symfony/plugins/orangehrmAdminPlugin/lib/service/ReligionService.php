...
class ReligionService extends BaseService{
  private $religionDao;
    ...
    public function getReligionDao() {
        return $this->religionDao;
    }

    public function setReligionDao(ReligionDao $religionDao) {
    ...
    public function deleteReligions($religionList) {
        return $this->religionDao->deleteReligions($religionList);
    }
