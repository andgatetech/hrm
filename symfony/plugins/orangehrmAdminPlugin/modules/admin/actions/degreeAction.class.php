...
class degreeAction extends sfAction {
    ...
    public function execute($request) {
        ...
        $this->form = new DegreeForm();
        $this->records = $this->getDegreeService()->getDegreeList();
    ...
    protected function _checkDuplicateEntry() {
        ...
        $object = $this->getDegreeService()->getDegreeByName($this->form->getValue('name'));
        ...
        if ($object instanceof Degree) {
            ...
            $this->getUser()->setFlash('warning', __('Degree Already Exists'));
            $this->redirect('admin/degree');            
